   ...
   <div class="content-page">
              ...
              <!--       <h4 class="mt-0 header-title">Textual inputs</h4>
                ...
                <form action="{{route('mechanicians.update',[$mechanician->id] )}}" method="post">
                     ...
                     <input type="hidden" name="_method" value="put">
                      <div class="form-group row"><label for="example-text-input" class="col-sm-2 col-form-label">mechanician Names</label>
    ...
    {{--
                    <div class="form-group row"><label for="example-url-input" class="col-sm-2 col-form-label">Website</label>
                        <div class="col-sm-10"><input class="form-control" type="url" value="{{$mechanician->website }}" id="example-url-input" name="website"></div>
                    </div>
                    --}}
