...
@section('content')
   <div class="content-page">
        ...
        @include('partials.error')
                ...
                <form action="{{route('garages.store')}}" method="post">
                     @csrf
                      <div class="form-group row"><label for="example-text-input" class="col-sm-2 col-form-label">garage Name</label>
                        <div class="col-sm-10"><input class="form-control" type="text"placeholder="Enter garage Name" id="example-text-input" name="name"></div>
                    </div>
            ...
            <div class="col-12 text-right"><button class="btn btn-primary w-md waves-effect waves-light" type="submit">{{ __('Add New garage') }}</button></div>
        </div>
                                </form>
